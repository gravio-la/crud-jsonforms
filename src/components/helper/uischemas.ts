...
export const uischemas: (schema: JsonSchema, baseIRI: string) => JsonFormsUISchemaRegistryEntry[] =
    (schema , baseIRI) => allDefinitions(schema as JSONSchema7).map((key) => createUiSchema(key, baseIRI, undefined, 'definitions'))
